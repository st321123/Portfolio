...
function First() {
  ...
  return (
    <div className=' text-teal-800 relative  flex flex-col xs:items-center text-center justify-center   px-10 pt-2 space-y-4   xs:h-[calc(100vh-43px)] xs:py-2 '>
      ...
      <div className=' flex flex-col items-center text-center mx-auto  '>
        ...
        <p className='font-sans  text-[16px] xs:text-[12px] sm:text-[16px] mt-1 text-left p-2 xs:text-center '>Seeking a challenging career opportunity to utilize my diverse skill set
